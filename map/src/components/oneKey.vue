...
<template>
  <div class="content">
    ...
    <div :class="{
      ...
      <Button ghost @click="stacData=false">一键选址
      ...
      <Row style="margin-top: 10px;" v-if="stacData">
        ...
        <!--<Col span="8" style="color: #5cadff;margin-top: 12px">热力峰值：{{value2}}</Col>-->
        <!--<Col span="12" style="color: #5cadff;margin-top: 12px">全城热力图：{{switch1===true?'开启':'关闭'}}</Col>-->
      </Row>
      <div class="box" v-if="!stacData">

        <Row>
          <Col span="7" style="color: #5cadff;margin-top: 14px;padding-left: 10px">品类</Col>
        ...
        <!--</Row>-->
        <!--<Row>-->
          <!--<Col span="7" style="color: #5cadff;margin-top: 35px;padding-left: 10px">热力值调节</Col>-->
          <!--<Col span="17" style="color: #ffffff;margin-top: 30px">-->
            <!--<InputNumber :max="1000" :min="0" :step="10" v-model="value2" :editable="false"-->
                         <!--style="font-size: 14px"></InputNumber>-->
            <!--<Button @click="setSeach()" size="small" type="text" ghost-->
  ...
  export default {
    ...
    mounted() {
      ...
      function mapS(j, w) {
        ...
        var myIcon1 = new BMap.Icon("https://smh-map.oss-cn-beijing.aliyuncs.com/sj.png", new BMap.Size(60, 60));
        var marker1 = new BMap.Marker(new BMap.Point(121.47, 31.25), {icon: myIcon}); // 创建点
        map.addOverlay(marker1);              // 将标注添加到地图中

        var myIcon2 = new BMap.Icon("https://smh-map.oss-cn-beijing.aliyuncs.com/sj.png", new BMap.Size(60, 60));
        var marker2 = new BMap.Marker(new BMap.Point(121.43, 31.25), {icon: myIcon}); // 创建点
        ...
        var circle = new BMap.Circle(point, 1000, {
          ...
          strokeWeight: 2,
          strokeOpacity: 0.5,
          fillColor: 'rgba(81, 90, 110, .2)'
        }); //创建圆
        var circle1 = new BMap.Circle(new BMap.Point(121.47, 31.25), 1000, {
          strokeColor: "blue",
          strokeWeight: 2,
          strokeOpacity: 0.5,
          fillColor: 'rgba(81, 90, 110, .2)'
        }); //创建圆
        var circle2 = new BMap.Circle(new BMap.Point(121.43, 31.25), 1000, {
          strokeColor: "blue",
          strokeWeight: 2,
          strokeOpacity: 0.5,
          fillColor: 'rgba(81, 90, 110, .2)'
